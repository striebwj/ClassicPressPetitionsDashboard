			...
			echo '<ul class="cp_petitions">';
				...
				?>
						<li>
							...
							<table>
								<tr>
									<td><strong><?php echo esc_attr__( 'Up Votes:', $this->text_domain ) . ' '; ?></strong><span class="votes-count"><?php echo esc_attr( $value['votesCount'] ); ?></span></td>
									...
									<td><strong><?php echo esc_attr__( 'Created:', $this->text_domain ) . ' '; ?>:</strong><?php echo human_time_diff(  strtotime($value['createdAt']), current_time('timestamp') ) . ' ' . esc_attr__( 'ago', $this->text_domain ); ?> </td>
								</tr>
							</table>
						</li>
				<?php
